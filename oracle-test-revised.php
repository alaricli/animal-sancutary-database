...
<html>
    ...
    <body>
        ...
        <form method="POST" action="oracle-test-revised.php">
        ...
        <form method="POST" action="oracle-test-revised.php"> <!--refresh page when submitted-->
        ...
        <form method="GET" action="oracle-test-revised.php"> <!--refresh page when submitted-->
